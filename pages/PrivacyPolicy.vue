<template>
  <div>
    <h2>Privacy Policy for Active-Ambassadors</h2>
    <section>
      <p>
        At Active-Ambassadors, accessible from
        https://www.active-ambassadors.org, one of our main priorities is the
        privacy of our visitors. This Privacy Policy document contains types of
        information that is collected and recorded by Active-Ambassadors and how
        we use it.
      </p>
      ...
      <p>
        Active-Ambassadors legal basis for collecting and using the personal
      ...
      <ul>
        <li>Active-Ambassadors needs to perform a contract with you</li>
        <li>You have given Active-Ambassadors permission to do so</li>
        <li>
          Processing your personal information is in Active-Ambassadors
          legitimate interests
        </li>
        <li>Active-Ambassadors needs to comply with the law</li>
      </ul>

      <p>
        Active-Ambassadors will retain your personal information only for as
      ...
      <p>
        Active-Ambassadors follows a standard procedure of using log files.
      ...
      <p>
        Like any other website, Active-Ambassadors uses 'cookies'. These cookies
      ...
      <P
        ...
        advertising partners of Active-Ambassadors.</P
      >

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Active-Ambassadors, which are
      ...
      <p>
        Note that Active-Ambassadors has no access to or control over these
      ...
      <p>
        Active-Ambassadors's Privacy Policy does not apply to other advertisers
      ...
      <p>
        Active-Ambassadors does not knowingly collect any Personal Identifiable
      ...
      <p>
        ...
        Active-Ambassadors. This policy is not applicable to any information
